...
#sed -i '' "s/<script src.*/<script src="main.dart.js?version=$buildNumber" type="application/javascript"></script>/" web/index.html
sed -i '' "s/<script src=\"main.dart.*/<script src=\"main.dart.js?version=$buildNumber\" type=\"application\/javascript\"><\/script>/" web/index.html
